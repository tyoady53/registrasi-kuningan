    ...
    <div class="collapse navbar-collapse  w-auto " id="sidenav-collapse-main">
        <ul class="navbar-nav">
            ...
            <li class="nav-item mt-3 d-flex align-items-center">
                ...
                <h6 class="ms-2 text-uppercase text-xs font-weight-bolder opacity-6 mb-0">Materi Ujian</h6>
            </li>
            <li class="nav-item">
                <a class="nav-link {{ str_contains(request()->url(), 'judges') == true ? 'active' : '' }}" href="{{ route('page', ['page' => 'judges/index']) }}">
                    <div
                        class="icon icon-shape icon-sm border-radius-md text-center me-2 d-flex align-items-center justify-content-center">
                        <i class="fa fa-files text-danger text-sm opacity-10"></i>
                    </div>
                    <span class="nav-link-text ms-1">Upload Materi</span>
                </a>
            </li>
            @endif --}}
            {{-- <li class="nav-item mt-3 d-flex align-items-center">
