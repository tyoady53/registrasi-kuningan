...
@section('content')
    ...
    <div class="card shadow-lg mx-4 card-profile-bottom" id="user_info">
        <div class="card-body p-3">
            <div class="row gx-4">
                <form role="form" method="post" action="{{ route('user.update', $user->slug) }}">
                    @csrf
                    <div class="row">
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="fw-bold">First Name</label>
                                <input class="form-control" value="{{ $user->firstname }}" name="firstname" type="text" placeholder="First Name">
                            </div>
                        </div>
                        <div class="col-md-6">
                            <div class="mb-3">
                                <label class="fw-bold">Last Name</label>
                                <input class="form-control" value="{{ $user->lastname }}" name="lastname" type="text" placeholder="Last Name">
                            </div>
                        </div>
                    </div>
                    <div class="row">
                    ...
                    <div class="mb-3">
                        ...
                        @foreach ($roles as $role)
                            <div class="form-check form-check-inline">
                                <input class="form-check-input" type="radio" value="{{ $role->id }}" name="roles" id="{{ $role->id }}" @if($user->roles[0]->id == $role->id) checked @endif>
